...
import { IParada, IBffResponse } from "@hub/types";
...
export function HeroRotativo({ pinned, setPinned, activeTab, onSourceChange }: HeroRotativoProps) {
  ...
  return (
    <section
      className="absolute inset-0 w-full h-full bg-cover bg-center rounded-[32px] overflow-hidden shadow-[0_0_40px_rgba(0,0,0,0.1)] group pointer-events-auto transition-all duration-700"
      style={{ backgroundImage: `url(${heroImg})` }}
    >
      <div className="absolute inset-0 bg-gradient-to-t from-[#01253a] via-[#01253a]/60 to-transparent mix-blend-multiply" />
      <div className="absolute inset-0 bg-[#005174]/10 mix-blend-overlay" />
